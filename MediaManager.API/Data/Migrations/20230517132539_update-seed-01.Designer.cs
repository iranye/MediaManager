...
namespace MediaManager.API.Migrations
{
    ...
    [Migration("20230517132539_update-seed-01")]
    partial class updateseed01
    {
            ...
            modelBuilder.Entity("MediaManager.API.Data.Entities.M3uFile", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTimeOffset(new DateTime(2023, 5, 17, 9, 25, 38, 950, DateTimeKind.Unspecified).AddTicks(9920), new TimeSpan(0, -4, 0, 0, 0)),
                            Title = "ShaNaNa.m3u",
                            TotalMegaBytes = 42,
                            VolumeId = 1
                        },
                        ...
                        {
                            Id = 2,
                            Created = new DateTimeOffset(new DateTime(2023, 5, 17, 9, 25, 38, 950, DateTimeKind.Unspecified).AddTicks(9945), new TimeSpan(0, -4, 0, 0, 0)),
                        ...
                        {
                            Id = 3,
                            Created = new DateTimeOffset(new DateTime(2023, 5, 17, 9, 25, 38, 950, DateTimeKind.Unspecified).AddTicks(9948), new TimeSpan(0, -4, 0, 0, 0)),
            ...
            modelBuilder.Entity("MediaManager.API.Data.Entities.Volume", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTimeOffset(new DateTime(2023, 5, 17, 9, 25, 38, 949, DateTimeKind.Unspecified).AddTicks(8566), new TimeSpan(0, -4, 0, 0, 0)),
                            Moniker = "kgon-01",
                            Title = "KGON-01"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTimeOffset(new DateTime(2023, 5, 17, 9, 25, 38, 949, DateTimeKind.Unspecified).AddTicks(8612), new TimeSpan(0, -4, 0, 0, 0)),
                            Moniker = "mellow-01",
                            Title = "Mellow-01"
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTimeOffset(new DateTime(2023, 5, 17, 9, 25, 38, 949, DateTimeKind.Unspecified).AddTicks(8615), new TimeSpan(0, -4, 0, 0, 0)),
                            Moniker = "kgon-02",
                            Title = "KGON-02"
                        });
                });
