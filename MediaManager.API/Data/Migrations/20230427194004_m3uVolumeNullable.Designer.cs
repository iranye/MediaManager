...
namespace MediaManager.API.Migrations
{
    ...
    [Migration("20230427194004_m3uVolumeNullable")]
    partial class m3uVolumeNullable
    {
            ...
            modelBuilder.Entity("MediaManager.API.Data.Entities.M3uFile", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 4, 27, 15, 40, 4, 715, DateTimeKind.Local).AddTicks(2363),
                            Title = "ShaNaNa.m3u",
                            TotalMegaBytes = 42,
                            VolumeId = 1
                        },
                        ...
                        {
                            Id = 2,
                            Created = new DateTime(2023, 4, 27, 15, 40, 4, 715, DateTimeKind.Local).AddTicks(2366),
                        ...
                        {
                            Id = 3,
                            Created = new DateTime(2023, 4, 27, 15, 40, 4, 715, DateTimeKind.Local).AddTicks(2368),
            ...
            modelBuilder.Entity("MediaManager.API.Data.Entities.Volume", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 4, 27, 15, 40, 4, 715, DateTimeKind.Local).AddTicks(2257),
                            Moniker = "kgon-01",
                            Title = "KGON-01"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2023, 4, 27, 15, 40, 4, 715, DateTimeKind.Local).AddTicks(2285),
                            Moniker = "mellow-01",
                            Title = "Mellow-01"
                        });
                });
